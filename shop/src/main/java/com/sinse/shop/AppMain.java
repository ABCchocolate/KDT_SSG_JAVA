...
public class AppMain extends JFrame {
   ...
   JPanel p_north; // p_util과 p_navi를 공존시켜야 하므로
   ...
   public AppMain() {
      ...
      // 생성
      p_north = new JPanel(new FlowLayout(FlowLayout.LEFT, 0, 0)); // new FlowLayout(FlowLayout.LEFT,0,0) -> 왼쪽 부터 상하좌우 마진 없애기
      ...
      createPage(); //앱이 가동될 때 무든 페이지 생성 및 부착
      //그 부착된 페이지들 중, 보고싶은 페이지의 index를 넘기자
   ...
   //원하는 페이지를 보여주는 메서드 정의 (p_container에 부착)
